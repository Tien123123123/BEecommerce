...
public class ProductEntity extends BaseEntity {
    ...
    @ManyToMany
    @JoinTable(name = "product_categories", joinColumns = @JoinColumn(name = "product_id"), inverseJoinColumns = @JoinColumn(name = "category_id", nullable = false))
    ...
    // * Helper
    public void addVariant(ProductVariantEntity entity) {
